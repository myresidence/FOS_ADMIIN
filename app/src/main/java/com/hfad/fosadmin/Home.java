...
import com.hfad.fosadmin.Model.Order;
import com.hfad.fosadmin.Service.ListenOrder;
import com.hfad.fosadmin.ViewHolder.MenuViewHolder;
...
public class Home extends AppCompatActivity
    ...
    private void showDialog(){
        ...
        btnSelect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                chooseImage();// Let User select image from gallary ans save url of this image
            }
        });
        ...
        btnUpload.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                uploadImage();// Let User upload image to firebase
            }
        });
           ...
           protected void populateViewHolder(MenuViewHolder viewHolder, Category model, int position) {
               ...
               viewHolder.setItemClickListener(new ItemClickListener() {
                   ...
                   public void onClick(View view, int position, boolean isLongClick) {
                       //send Category Is and Start and Start New Activity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_orders) {
            ...
            Intent orders = new Intent(Home.this,OrderSatus.class);
    ...
    private void showUpdateDialog(final String key, final Category item){
        ...
        btnUpload.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                changeImage(item);// Let User upload image to firebase
            }
        });
